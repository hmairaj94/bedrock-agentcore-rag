...
REGION = "ap-south-1"
MEMORY_ID = "agent_with_memory_mem-Wf8wtp8gPN"
            ...
            if isinstance(msg, HumanMessage):
                ...
                try:
                    preferences = store.search(
                        user_preferences_namespace, query=msg.content, limit=5
                    )
...
# Initialize the LLM
llm = init_chat_model(
    model="openai/gpt-oss-20b", model_provider="groq", api_key=GROQ_API_KEY
)
...
def agent_invocation(payload, context):
    ...
    # Return the answer
    return {"result": answer, "actor_id": actor_id, "thread_id": thread_id}
